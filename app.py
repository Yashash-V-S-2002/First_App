...
st.text("The prediction here is based on the data available, hence might not allign with real life data.")
...
ssd=st.radio("SSD capacity(in GB)",[0,8,16,32,64,128,256,512,1000,2000],index=7,horizontal=True)
